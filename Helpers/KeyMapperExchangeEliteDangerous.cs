namespace Helpers
{
    ...
    /// </summary>
    public class KeyMapperExchangeEliteDangerous
    {
        private Dictionary<string, string> relationship = new Dictionary<string, string>();

        /// <summary>
        /// Initializes a new instance of the <see cref="KeyMapperExchangeEliteDangerous"/> class
        /// </summary>
        public KeyMapperExchangeEliteDangerous()
        {
        }
        ...
        public KeyMapperExchangeEliteDangerous(Enums.KeyboardEnumType keyType)
        {
