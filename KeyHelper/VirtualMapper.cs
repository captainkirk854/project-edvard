namespace KeyHelper
{
    ...
    /// </summary>
    public static class VirtualMapper
    {
        /// <summary>
        ...
        public static string GetUnicodeValueFromWindowsInputKeyEnumValueWithOptionalModifiers(string windowsFormsKeysEnum, bool shift, bool caps, bool altGr)
        {
            ...
            System.Windows.Forms.Keys enumKey = StockThings.ParseStringToEnum<System.Windows.Forms.Keys>(windowsFormsKeysEnum);
        ...
        public static string GetUnicodeValueFromWindowsInputKeyEnumValue(string windowsInputKeyEnum)
        {
            ...
            System.Windows.Input.Key enumKey = StockThings.ParseStringToEnum<Key>(windowsInputKeyEnum);
