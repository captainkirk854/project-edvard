namespace GameKey.Adapter
{
    ...
    /// </summary>
    public class GameAndSystemKeyDictionary
    {
        private Dictionary<string, string> relationship = new Dictionary<string, string>();

        /// <summary>
        /// Initializes a new instance of the <see cref="GameAndSystemKeyDictionary"/> class
        /// </summary>
        public GameAndSystemKeyDictionary()
        {
        }
        ...
        public GameAndSystemKeyDictionary(Items.Application.Name game)
        {
